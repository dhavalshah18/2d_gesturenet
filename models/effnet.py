"""effnet.py - Model and module class for EfficientNet.
...
class MBConvBlock(nn.Module):
    ...
    Args:
        block_args (namedtuple): BlockArgs, defined in effnet_utils.py.
        global_params (namedtuple): GlobalParam, defined in effnet_utils.py.
